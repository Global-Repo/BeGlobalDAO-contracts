 ...
 */
contract IPSO4 is ReentrancyGuard, Ownable {
  ...
  constructor(
    ...
    function canInvestMax(address _user) public view returns (uint)
    {
        ...
        return raisingAmount.mul(24).div(10) >= totalAmountInvested ? amountToInvest : 0;
    }
    ...
    function invest(uint256 _amount) public
    {
        ...
        require (raisingAmount.mul(24).div(10) >= totalAmountInvested, 'IPSO already full');
