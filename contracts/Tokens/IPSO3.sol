 ...
 */
contract IPSO3 is ReentrancyGuard, Ownable {
  ...
  constructor(
    ...
    function canInvestMax(address _user) public view returns (uint)
    {
        ...
        return raisingAmount > totalAmountInvested ? amountToInvest : 0;
    }
    ...
    function invest(uint256 _amount) public
    {
        ...
        require (raisingAmount > totalAmountInvested, 'IPSO already full');
