...
async function main() {
    ...
    let startSale = 1648072800;
    let endSale = 1648159200;
    let endClaim = 1651784400;
    let ratioRequiredWGLBDNum = 750; //750
    let ratioRequiredWGLBDDenum = 4761904761; //4761904761
    let amountForWhitelisted = 750;
    let minInvestment = 4761904761;
    let maxInvestment = 99999;
    let raisingAmount = 180000;
