...
async function main() {
    ...
    let startSale = 1648832400;
    let endSale = 1648929600;
    let endClaim = 1653066000;
    let ratioRequiredWGLBDNum = 1; //1000
    let ratioRequiredWGLBDDenum = 16666666; //16666666666
    let amountForWhitelisted = 1000;
    let minInvestment = 16666666000;
    let maxInvestment = 99999;
    let raisingAmount = 85700;
