...
async function main() {
    ...
    let startSale = 1648670400;
    let endSale = 1648929600;
    let endClaim = 1652731200;
    let ratioRequiredWGLBDNum = 3; //300
    let ratioRequiredWGLBDDenum = 71428571; //7142857142
    let amountForWhitelisted = 300;
    let minInvestment = 7142857100;
    let maxInvestment = 99999;
    let raisingAmount = 8465;

    //MAINNET
    console.log("[Deploying IPSO4 SC]");
