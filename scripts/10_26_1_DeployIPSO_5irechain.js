...
async function main() {
    ...
    let startWhitelist = 1660680000;
    let endWhitelist = 1661457600;
    let startPublicSale = 1660680000;
    let endPublicSale = 1661457600;
    let startVesting = 1661457600;
    let endVesting = 1664654400;
    let ratioRequiredWGLBDNum = 500;
    let ratioRequiredWGLBDDenum = 6206896551;
    let amountForWhitelisted = 500;
    let minInvestment = 500;
    let maxInvestment = 37500;
    let raisingAmount = 15000;
    let hardCap = 37500;
