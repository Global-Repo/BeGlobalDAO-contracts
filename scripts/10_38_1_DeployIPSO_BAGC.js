...
async function main() {
    ...
    let startSale = 1670191200; //1670191200;
    let endSale = 1670274000;
    let endClaim = 1670274300;
    let ratioRequiredWGLBDNum = 75;
    let ratioRequiredWGLBDDenum = 32258064500;
    let amountForWhitelisted = 750000000;
    let minInvestment = 322580645; //5128205127
    let maxInvestment = 750000000;
    ...
    let ipso = await IPSO.deploy(
        ...
        BigNumber.from(maxInvestment).mul(BIG_NUMBER_TOKEN_DECIMALS_MULTIPLIER_LITTLE),
