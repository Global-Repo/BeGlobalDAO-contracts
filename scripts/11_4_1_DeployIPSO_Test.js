...
async function main() {
    ...
    let startSale = 1663012800;
    let endSale = 1663016400;
    let endClaim = 1663019940;
    let ratioRequiredWGLBDNum = 1;
    let ratioRequiredWGLBDDenum = 33333333;
    let amountForWhitelisted = 10;
    let minInvestment = 166666666;
