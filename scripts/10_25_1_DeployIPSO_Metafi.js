...
async function main() {
    ...
    let startSale = 1659812400;
    let endSale = 1659898800;
    let endClaim = 1663268400;
    let ratioRequiredWGLBDNum = 562;
    let ratioRequiredWGLBDDenum = 8620689655;
    let amountForWhitelisted = 562;
    let minInvestment = 8620689655;
    let maxInvestment = 8988;
    let raisingAmount = 8988;
