...
async function main() {
    ...
    let startWhitelist = 1650474800; // 1650574800
    let endWhitelist = 1651870800; // 1651870800
    let startPublicSale = 1650474800; // 1650574800
    let endPublicSale = 1651870800; // 1651870800
    let startVesting = 1651870800; // 1651870800
    let endVesting = 1656190800; // 1656190800;
    let ratioRequiredWGLBDNum = 750; // 750
    let ratioRequiredWGLBDDenum = 250; // 250
    let amountForWhitelisted = 1000; // 1000
    let minInvestment = 750; // 750
    let maxInvestment = 0; // 0
    let raisingAmount = 10000; // 131664
    let hardCap = 0; // 0

    //MAINNET
    console.log("[Deploying IPSO8 SC]");
    const IPSO = await ethers.getContractFactory('IPSO8');
