...
async function main() {
    ...
    let startSale = 1658520000;
    let endSale = 1658952000;
    let endClaim = 1664308800;
    let ratioRequiredWGLBDNum = 300;
    let ratioRequiredWGLBDDenum = 5172413793;
    let amountForWhitelisted = 500;
    let minInvestment = 5172413793;
    let maxInvestment = 99999999;
    let raisingAmount = 9999999999;
